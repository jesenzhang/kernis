...
impl ModuleVersion {
    /// Creates a version from a non-empty, non-whitespace value.
    ///
    /// # Errors
    ///
    /// Returns [`LoaderError::InvalidReference`] when the value is blank.
...
#[cfg(test)]
mod tests {
    use super::{ModuleReference, ModuleVersion};
