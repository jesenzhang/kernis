...
The durable value is a version-5 `postcard 1.1.3` snapshot of the run id and
ordered commit ledger, prefixed with a Kernis format magic, schema version, and
